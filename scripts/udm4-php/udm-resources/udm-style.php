...
if (!isset($tipo_menu)) $tipo_menu='horizontal';
...
$umr[$j++]='@media all and (min-width:0px){ul[class$="udm"].udm .udmS{background:transparent;'.(preg_match('/(gif|png|mng|jpg|jpeg|jpe|bmp)/i',$um['menus'][9])?'background-image:url('.$um['baseSRC'].$um['menus'][9].');':'background-image:none;background-color:'.$um['menus'][9].';').$umrg.'}}';
}
}
...
$umr[$j++]='.udm li a.udmR,.udm li a.udmY,.udm li'.$um['t'][35].',.udm li'.$um['t'][37].',.udm li a:hover,.udm li a:focus,.udm li'.$um['t'][27].',.udm li'.$um['t'][26].'{font-style:'.$um['items'][23].';'.(preg_match('/(gif|png|mng|jpg|jpeg|jpe|bmp)/i',$um['items'][12])?'background-image:url('.$um['baseSRC'].$um['items'][12].');':'background-image:none;background-color:'.$um['items'][12].';').$um['t'][11].$um['items'][17].';color:'.$um['items'][20].';'.$um['t'][6].$um['items'][5].';'.$um['t'][7].$um['items'][6].';'.$um['t'][5].$um['items'][1].'px;'.$um['items'][26].'}';
