 ...
 *
 * Uso:
 *   php tools/phpstan/phpstan_baseline_priorities.php [ruta/baseline.neon]
 *   php tools/phpstan/phpstan_baseline_priorities.php --summary
 *   php tools/phpstan/phpstan_baseline_priorities.php --stdout   (CSV a stdout en lugar de build/)
 *
...
$baselinePath = $pathArgs[0] ?? dirname(__DIR__, 2) . '/phpstan-baseline.neon';
...
$outDir = dirname(__DIR__, 2) . '/build';
