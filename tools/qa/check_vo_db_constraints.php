...
final class VoDbValidatorCli
{
    ...
    private function parseOptions(): array
    {
        ...
        $output = (string)($options['output'] ?? 'docs/dev/reports/vo_db_validation_report.json');
    ...
    {
        $repoFiles = glob(dirname(__DIR__, 2) . '/src/*/infrastructure/persistence/postgresql/Pg*Repository.php');
...
SQL;
    ...
    private function printUsage(): void
    {
        $usage = <<<TXT
Uso:
  php tools/qa/check_vo_db_constraints.php --module=profesores --esquema=H-dlbv [opciones]
  php tools/qa/check_vo_db_constraints.php --module=all --esquemas=H-dlbv,H-madv [opciones]
