...
class SfsvIdTest extends myTest
{
    ...
    {
        $sfsvId1 = new SfsvOtrosId(SfsvOtrosId::SV);
        $sfsvId2 = new SfsvOtrosId(SfsvOtrosId::SV);
    ...
    {
        $sfsvId1 = new SfsvOtrosId(SfsvOtrosId::SV);
        $sfsvId2 = new SfsvOtrosId(SfsvOtrosId::SF);
        $this->assertFalse($sfsvId1->equals($sfsvId2));
    }

    public function test_fromNullableInt_returns_instance_for_valid_value()
    {
        $sfsvId = SfsvOtrosId::fromNullableInt(SfsvOtrosId::SV);
        $this->assertInstanceOf(SfsvOtrosId::class, $sfsvId);
    }

    public function test_fromNullableInt_returns_null_for_null_value()
    {
        $sfsvId = SfsvOtrosId::fromNullableInt(null);
