...
/**
 * Smoke test que recorre todo src/procesos/application/*.php y verifica:
 *  - fichero existe y es legible
 *  - pasa `php -l`
 *  - empieza por <?php
 *  - namespace coincide con la carpeta
 */
final class ProcesosApplicationSyntaxTest extends TestCase
{
    public static function applicationFilesProvider(): array
    {
        $baseDir = __DIR__ . '/../../../../src/procesos/application';
        $files = [];
