...
class CertificadoRecididoDeleteTest extends myTest
{
    private int $id_nom;
    ...
    public function test_delete_certificados()
    {
        ...
        foreach ($this->cCertificados as $Certificado) {
            ...
            $CertificadoDB = $CertificadoRecibidoUpload->uploadNew($id_item, $id_nom, $contenido_doc, $idioma, $certificado, $firmado, $oF_certificado, $oF_recibido, $destino);
