...
class ConfigParametroCodeTest extends myTest
{
    ...
    {
        $configParametroCode = new ConfigParametroCode('test_value');
        $this->assertEquals('test_value', $configParametroCode->value());
    }
    ...
    {
        $configParametroCode1 = new ConfigParametroCode('test_value');
        $configParametroCode2 = new ConfigParametroCode('test_value');
    ...
    {
        $configParametroCode1 = new ConfigParametroCode('test_value');
        $configParametroCode2 = new ConfigParametroCode('alternative_value');
    ...
    {
        $configParametroCode = new ConfigParametroCode('test_value');
        $this->assertEquals('test_value', (string)$configParametroCode);
    }

    public function test_fromNullableString_returns_instance_for_valid_value()
    {
        $configParametroCode = ConfigParametroCode::fromNullableString('test_value');
