...
/**
 * Factory para crear instancias de PersonaPub para tests
 * Generado automáticamente - puede ser modificado según necesidades
 */
class PersonaPubFactory
{
    private int $count = 1;
    ...
    /**
     * Crea una instancia simple de PersonaPub con datos mínimos
     * Útil para tests que no requieren datos complejos
     */
    public function createSimple(?int $id = null): PersonaPub
    {
        $id = $id ?? (9900000 + random_int(1000, 9999));
        $oPersonaPub = new PersonaPub();
    ...
    /**
     * Crea una instancia de PersonaPub con datos realistas usando Faker
     * @param int|null $id ID específico o null para generar uno aleatorio
     * @return PersonaPub
     */
    public function create(?int $id = null): PersonaPub
    {
    ...
    /**
     * Crea múltiples instancias de PersonaPub
