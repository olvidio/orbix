...
/**
 * Comprueba que los controladores HTTP del modulo `zonassacd` son
 * legibles y pasan el lint de PHP sin ejecutarlos (el lint no puede
 * mirar dentro del cuerpo en busca de typos de metodos dinamicos,
 * pero al menos garantiza que ninguno tenga errores de sintaxis).
 */
final class ZonassacdControllersSyntaxTest extends TestCase
{
    public static function controllersProvider(): array
    {
        $baseDir = __DIR__ . '/../../../../../src/zonassacd/infrastructure/ui/http/controllers';
