...
class PgActaExRepositoryTest extends myTest
{
    private ActaExRepositoryInterface $repository;
    private ActaFactory $factory;

    public function setUp(): void
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(ActaExRepositoryInterface::class);
    ...
    {
        $this->assertNull($this->repository->findById('zzz inexistente ex 99/99'));
    }
}
