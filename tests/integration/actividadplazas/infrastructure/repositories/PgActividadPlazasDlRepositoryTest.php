...
namespace Tests\integration\actividadplazas\infrastructure\persistence\postgresql;
...
class PgActividadPlazasDlRepositoryTest extends myTest
{
    ...
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(ActividadPlazasDlRepositoryInterface::class);
