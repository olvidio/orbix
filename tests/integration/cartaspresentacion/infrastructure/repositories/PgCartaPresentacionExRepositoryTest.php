...
class PgCartaPresentacionExRepositoryTest extends myTest
{
    private CartaPresentacionExRepositoryInterface $repository;
    private CartaPresentacionFactory $factory;

    public function setUp(): void
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(CartaPresentacionExRepositoryInterface::class);
