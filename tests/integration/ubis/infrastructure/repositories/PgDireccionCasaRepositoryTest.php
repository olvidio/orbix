...
class PgDireccionCasaRepositoryTest extends myTest
{
    private DireccionCasaRepositoryInterface $repository;
    private DireccionFactory $factory;

    public function setUp(): void
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(DireccionCasaRepositoryInterface::class);
