...
class PgDireccionCasaExRepositoryTest extends myTest
{
    private DireccionCasaExRepositoryInterface $repository;
    private DireccionFactory $factory;

    public function setUp(): void
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(DireccionCasaExRepositoryInterface::class);
