...
class PgCasaDlRepositoryTest extends myTest
{
    private CasaDlRepositoryInterface $repository;
    private CasaFactory $factory;

    public function setUp(): void
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(CasaDlRepositoryInterface::class);
