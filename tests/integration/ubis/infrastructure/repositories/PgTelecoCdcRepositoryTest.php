...
class PgTelecoCdcRepositoryTest extends myTest
{
    private TelecoCdcRepositoryInterface $repository;
    private TelecoUbiFactory $factory;

    public function setUp(): void
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(TelecoCdcRepositoryInterface::class);
