...
class PgDireccionCentroDlRepositoryTest extends myTest
{
    private DireccionCentroDlRepositoryInterface $repository;
    private DireccionFactory $factory;

    public function setUp(): void
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(DireccionCentroDlRepositoryInterface::class);
