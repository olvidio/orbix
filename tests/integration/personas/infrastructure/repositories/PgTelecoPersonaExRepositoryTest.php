...
class PgTelecoPersonaExRepositoryTest extends myTest
{
    private TelecoPersonaExRepositoryInterface $repository;
    private TelecoPersonaFactory $factory;

    public function setUp(): void
    {
        parent::setUp();
        $this->repository = $GLOBALS['container']->get(TelecoPersonaExRepositoryInterface::class);
