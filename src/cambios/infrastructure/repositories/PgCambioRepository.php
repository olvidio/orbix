...
class PgCambioRepository extends ClaseRepository implements CambioRepositoryInterface
{
    ...
    public function getCambiosNuevos(): array
    {
        ...
        foreach ($stmt as $aDades) {
            $oCambio = new Cambio();
            $oCambio->setAllAttributes($aDades);
    ...
    public function getCambios(array $aWhere = [], array $aOperators = []): array|false
    {
        ...
        foreach ($filas as $aDatos) {
            ...
            // para los json
            $aDatos['json_fases_sv'] = (new ConverterJson($aDatos['json_fases_sv']))->fromPg();
            $aDatos['json_fases_sf'] = (new ConverterJson($aDatos['json_fases_sf']))->fromPg();
            $CambioDl = new Cambio();
            $CambioDl->setAllAttributes($aDatos);
    ...
    public function Guardar(Cambio $Cambio): bool
    {
        ...
        // para los json
        $aDatos['json_fases_sv'] = (new ConverterJson($Cambio->getJson_fases_sv()))->toPg();
        $aDatos['json_fases_sf'] = (new ConverterJson($Cambio->getJson_fases_sf()))->toPg();
        ...
        if ($bInsert === false) {
             ...
             */
            $mi_esquema = 3000;
            $aDatos['id_item_cambio'] = $Cambio->getId_item_cambio();
    ...
    public function findById(int $id_item_cambio): ?Cambio
    {
        ...
        return (new Cambio())->setAllAttributes($aDatos);
    }
