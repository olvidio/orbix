...
for ($m = 1; $m < 13; $m++) {
    $input["g$m"] = \src\shared\domain\helpers\FuncTablasSupport::inputString($_POST, "g$m");
    $input["ap_sv$m"] = \src\shared\domain\helpers\FuncTablasSupport::inputString($_POST, "ap_sv$m");
    $input["ap_sf$m"] = \src\shared\domain\helpers\FuncTablasSupport::inputString($_POST, "ap_sf$m");
}
