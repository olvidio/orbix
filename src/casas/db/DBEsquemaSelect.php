...
class DBEsquemaSelect extends DBEsquema
{
     ...
     */
    public function create_da_ingresos_dl_select(): void
    {
    ...
    public function create_du_gastos_dl_select(): void
    {
        // (debe estar después de fijar el role)
        $this->addPermisoGlobal('comun_select');
    ...
    public function create_du_grupos_dl_select(): void
    {
        // (debe estar después de fijar el role)
        $this->addPermisoGlobal('comun_select');
    ...
    public function eliminar_da_ingresos_dl_select(): void
    {
    ...
    public function eliminar_du_gastos_dl_select(): void
    {
    ...
    public function eliminar_du_grupos_dl_select(): void
    {
