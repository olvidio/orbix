...
class DBEsquema extends DBAbstract
{
     ...
     */
    public function create_da_ingresos_dl(): void
    {
    ...
    public function eliminar_da_ingresos_dl(): void
    {
        // (debe estar después de fijar el role)
        $this->addPermisoGlobal('comun');
    ...
    public function create_du_gastos_dl(): void
    {
        $this->addPermisoGlobal('comun');
    ...
    public function eliminar_du_gastos_dl(): void
    {
        $this->addPermisoGlobal('comun');
    ...
    public function create_du_grupos_dl(): void
    {
        $this->addPermisoGlobal('comun');
    ...
    public function eliminar_du_grupos_dl(): void
    {
        $this->addPermisoGlobal('comun');
