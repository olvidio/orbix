...
/* --------------------  BASiC SEARCH ---------------------------------------- */
	 ...
	 * @return array|bool Una colección de objetos de tipo RelacionTarifaTipoActividad
	
	 */
	public function getTipoActivTarifas(array $aWhere=[], array $aOperators=[]): array|bool;
