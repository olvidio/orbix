...
class DBEsquemaSelect extends DBEsquema
{
     ...
     */
    public function create_encargo_tipo_select(): void
    {
    ...
    public function eliminar_encargo_tipo_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $this->eliminarDeSVESelect("encargo_tipo");
    }

    public function create_encargos_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargos_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $this->eliminarDeSVESelect("encargos");
    }

    public function create_encargo_horario_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargo_horario_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $this->eliminarDeSVESelect("encargo_horario");
    }

    public function create_encargo_horario_excepcion_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargo_horario_excepcion_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $this->eliminarDeSVESelect("encargo_horario_excepcion");
    }

    public function create_encargo_sacd_horario_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargo_sacd_horario_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $this->eliminarDeSVESelect("encargo_sacd_horario");
    }

    public function create_encargo_sacd_horario_excepcion_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargo_sacd_horario_excepcion_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $this->eliminarDeSVESelect("encargo_sacd_horario_excepcion");
    }

    public function create_encargo_sacd_observ_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargo_sacd_observ_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $this->eliminarDeSVESelect("encargo_sacd_observ");
    }

    public function create_encargos_sacd_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargos_sacd_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $this->eliminarDeSVESelect("encargos_sacd");
    }

    public function create_encargo_datos_cgi_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargo_datos_cgi_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
    ...
    public function create_encargo_textos_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
        $esquema_org = $this->esquema;
        $role_org = $this->role;
    ...
    public function eliminar_encargo_textos_select(): void
    {
        // OJO Corresponde al esquema sf-e/sv-e, no al comun.
