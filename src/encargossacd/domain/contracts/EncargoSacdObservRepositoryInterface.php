...
/**
 * Interfaz de la clase EncargoSacdObserv y su Repositorio
 *
 * @package orbix
 * @subpackage model
 ...
 * @created 23/12/2025
 */
interface EncargoSacdObservRepositoryInterface
{
...
/* --------------------  BASiC SEARCH ---------------------------------------- */
	 ...
	 * @return list<EncargoSacdObserv> Una colección de objetos de tipo EncargoSacdObserv
