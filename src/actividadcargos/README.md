...
Este driver (`src/actividadcargos/infrastructure/cli/cargos_activ_resincronizar.php`)
queda para el menú web y para una pasada suelta. Recibe los mismos parámetros
...
ellos por línea de comandos. Hace falta aunque la reconciliación abra sus
