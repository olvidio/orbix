...
/**
 * Resultado de reconciliar `cd_cargos_activ_dl` en un esquema.
 *
 * @see ResincronizarCdCargosActiv
 */
final class CdCargosActivInformeEsquema
{
    /** @param list<string> $detalle columnas que difieren, por cargo */
    ...
    /** El esquema no aplica (no existe en una de las dos bases). */
