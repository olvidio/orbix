...
final class AsistentePlanEstOk
{
    ...
    public function execute(array $input): string
    {
        ...
        $Qest_ok = \src\shared\domain\helpers\FuncTablasSupport::inputString($input, 'est_ok');
        ...
        $oAsistente->setEst_ok(\src\shared\domain\helpers\FuncTablasSupport::isTrue($Qest_ok) === true);
