...
{
    public static function execute(int $idActiv, string $nomActivFromSel): array
    {
        ...
        foreach ($asistenteRepository->getAsistentes(['id_activ' => $idActiv]) as $oAsistente) {
            ...
            if (!array_key_exists($stgr, $aTiposStgr)) {
                continue;
            }
            ...
            $cNotas = $personaNotaRepository->getPersonaNotas($aWhere, $aOperador);
            $aAprobadas = [];
