...
$Qquien = (string)\src\shared\domain\helpers\FilterPostGet::post('quien');
...
if ($miRole < 4) { // es administrador
    ...
    if (!empty($Qid_usuario)) {
        ...
        $chk_cambio_password = \src\shared\domain\helpers\FuncTablasSupport::isTrue($cambio_password) ? 'checked' : '';
        $has_2fa = $oUsuario->isHas_2fa();
        $chk_has_2fa = \src\shared\domain\helpers\FuncTablasSupport::isTrue($has_2fa) ? 'checked' : '';
