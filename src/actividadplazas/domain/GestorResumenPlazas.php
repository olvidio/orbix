...
class GestorResumenPlazas
{
    ...
    public function getPosiblesPropietarios($dl_de_paso = FALSE)
    {
        ...
        $cActividadPlazas = $ActividadPlazasRepository->getActividadesPlazas(array('id_activ' => $id_activ));
    ...
    public function getPlazasCalendario($dl)
    {
        ...
        $ActividadPlazasRepository = $GLOBALS['container']->get(ActividadPlazasRepositoryInterface::class);
        // plazas de calendario de cada dl
        $cActividadPlazas = $ActividadPlazasRepository->getActividadesPlazas(array('id_activ' => $id_activ, 'id_dl' => $id_mi_dl, 'dl_tabla' => $dl_org));
        $plazas_calendario = 0;
        foreach ($cActividadPlazas as $oActividadPlazas) {
    ...
    public function getPlazasCedidas($dl)
    {
        ...
        $ActividadPlazasRepository = $GLOBALS['container']->get(ActividadPlazasRepositoryInterface::class);
        // plazas de calendario de cada dl
        $cActividadPlazas = $ActividadPlazasRepository->getActividadesPlazas(array('id_activ' => $id_activ, 'id_dl' => $id_mi_dl, 'dl_tabla' => $mi_dl));
        foreach ($cActividadPlazas as $oActividadPlazas) {
            $json_cedidas = $oActividadPlazas->getCedidas();
            $plazas_cedidas = 0;
            if (!empty($json_cedidas)) {
...
//			}
        ...
        $cActividadPlazas = $ActividadPlazasRepository->getActividadesPlazas(['id_activ' => $id_activ]);
        foreach ($cActividadPlazas as $oActividadPlazas) {
...
//					$a_plazas[$dl]['ocupadas'][$dl_otra] = $ocu;
    ...
    public function getPropiedadPlazaLibre()
    {
        ...
        if ($pl_propias > 0) {
            $plazasOcupadas = $service->getPlazasOcupadasPorDl($id_activ, $mi_dl, $mi_dl);
