 ...
 * @created 9/12/2025
 */
class PgPersonaNaxRepository extends PgPersonaDlRepositoryBase implements PersonaNaxRepositoryInterface
{
    ...
    {
        $id_nom = $PersonaNax->getId_nom();
        $oDbl = $this->getoDbl();
        $nom_tabla = $this->getNomTabla();
        $bInsert = $this->isNew($id_nom);

        $aDatos = $PersonaNax->toArrayForDatabase([
