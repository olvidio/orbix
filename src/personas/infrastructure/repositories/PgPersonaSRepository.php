 ...
 * @created 9/12/2025
 */
class PgPersonaSRepository extends PgPersonaDlRepositoryBase implements PersonaSRepositoryInterface
{
    ...
    {
        $id_nom = $PersonaS->getId_nom();
        $oDbl = $this->getoDbl();
        $nom_tabla = $this->getNomTabla();
        $bInsert = $this->isNew($id_nom);

        $aDatos = $PersonaS->toArrayForDatabase([
