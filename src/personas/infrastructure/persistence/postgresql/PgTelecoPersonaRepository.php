 ...
 * @created 12/12/2025
 */
class PgTelecoPersonaRepository extends ClaseRepository implements TelecoPersonaRepositoryInterface
{
     ...
     * @return array|bool Una colección de objetos de tipo TelecoPersona
     */
    public function getTelecosPersona(array $aWhere = [], array $aOperators = []): array|bool
    {
        $oDbl = $this->getoDbl();
        $nom_tabla = $this->getNomTabla();
        $TelecoPersonaSet = new Set();
    ...
    {
        $id_item = $TelecoPersona->getId_item();
        $oDbl = $this->getoDbl();
        $nom_tabla = $this->getNomTabla();
