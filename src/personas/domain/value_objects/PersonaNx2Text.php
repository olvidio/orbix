...
final class PersonaNx2Text
{
    ...
    private function validate(string $value): void
    {
        ...
        if (mb_strlen($value) > 7) {
            throw new \InvalidArgumentException('PersonaNx2Text must be at most 7 characters');
        }
        if (!preg_match('/^[A-Za-z0-9]+$/u', $value)) {
            throw new \InvalidArgumentException('PersonaNx2Text has invalid characters');
        }
    }
