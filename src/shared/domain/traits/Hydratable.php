...
trait Hydratable
{
     ...
     * 5. Convierte arrays PHP a formato PostgreSQL con \src\shared\domain\helpers\FuncTablasSupport::arrayPhp2pg()
    ...
    public function toArrayForDatabase(array $converters = []): array
    {
        ...
        foreach ($properties as $property) {
            ...
            elseif (is_array($value)) {
                $value = \src\shared\domain\helpers\FuncTablasSupport::arrayPhp2pg($value);
            }
        ...
        array_walk($data, [\src\shared\domain\helpers\FuncTablasSupport::class, 'ponerNull']);
