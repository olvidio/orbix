...
class Asignatura
{
     ...
     * @return DatosCampo
     */
    function getDatosId_nivel(): DatosCampo
    {
        $oDatosCampo = new DatosCampo();
     ...
     * @return DatosCampo
     */
    function getDatosNombre_asignatura(): DatosCampo
    {
        $oDatosCampo = new DatosCampo();
     ...
     * @return DatosCampo
     */
    function getDatosNombre_corto(): DatosCampo
    {
        $oDatosCampo = new DatosCampo();
     ...
     * @return DatosCampo
     */
    function getDatosCreditos(): DatosCampo
    {
        $oDatosCampo = new DatosCampo();
     ...
     * @return DatosCampo
     */
    function getDatosId_sector(): DatosCampo
    {
        $oDatosCampo = new DatosCampo();
     ...
     * @return DatosCampo
     */
    function getDatosStatus(): DatosCampo
    {
        $oDatosCampo = new DatosCampo();
     ...
     * @return DatosCampo
     */
    function getDatosId_tipo(): DatosCampo
    {
        $oDatosCampo = new DatosCampo();
