...
/**
 * Fragmento incluido desde crear_nuevo_periodo_data_build.php.
 * Los `use` deben repetirse aqui: no se heredan del fichero que hace require.
 */
...
foreach ($date_range as $date) {
    ...
    // Comienzo una semana antes para que sea Domingo de Ramos y no Domingo de Pascua.
