...
class PgPlantillaRepository extends ClaseRepository implements PlantillaRepositoryInterface
{
     ...
     * @return array|bool Una colección de objetos de tipo Plantilla
     */
    public function getPlantillas(array $aWhere = [], array $aOperators = []): array|bool
    {
    ...
    public function findById(int $id_item): ?Plantilla
    {
        ...
        return Plantilla::fromArray($aDatos);
    }
