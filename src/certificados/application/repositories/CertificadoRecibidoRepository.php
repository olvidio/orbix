 ...
 * @created 27/2/2023
 */
class CertificadoRecibidoRepository implements CertificadoRecibidoRepositoryInterface
{

    private PgCertificadoRecibidoRepository $repository;

    public function __construct()
    {
        $this->repository = new PgCertificadoRecibidoRepository();
    }
