 ...
 * @created 27/2/2023
 */
class CertificadoEmitidoRepository implements CertificadoEmitidoRepositoryInterface
{

    private PgCertificadoEmitidoRepository $repository;

    public function __construct()
    {
        $this->repository = new PgCertificadoEmitidoRepository();
    }
