...
class CertificadoRecibido
{
    ...
    function getDatosCampos()
    {
        ...
        //$oTipoDocSet->add($this->getDatosId_nom());
        $oTipoDocSet->add($this->getDatosNom());
        $oTipoDocSet->add($this->getDatosIdioma());
        $oTipoDocSet->add($this->getDatosDestino());
        $oTipoDocSet->add($this->getDatosCertificado());
        $oTipoDocSet->add($this->getDatosF_certificado());
        $oTipoDocSet->add($this->getDatosEsquema_emisor());
        $oTipoDocSet->add($this->getDatosFirmado());
        $oTipoDocSet->add($this->getDatosDocumento());
        $oTipoDocSet->add($this->getDatosF_recibido());
    ...
    function getDatosIdioma()
    {
        ...
        $oDatosCampo->setMetodoGet('getIdioma');
        $oDatosCampo->setMetodoSet('setIdioma');
    ...
    function getDatosDestino()
    {
        $oDatosCampo = new DatosCampo();
        $oDatosCampo->setNom_camp('destino');
        $oDatosCampo->setMetodoGet('getDestino');
        $oDatosCampo->setMetodoSet('setDestino');
        $oDatosCampo->setEtiqueta(_("destino"));
        $oDatosCampo->setTipo('texto');
        $oDatosCampo->setArgument(30);
        return $oDatosCampo;
    }

    function getDatosCertificado()
    {
        $oDatosCampo = new DatosCampo();
        $oDatosCampo->setNom_camp('certificado');
        $oDatosCampo->setMetodoGet('getCertificado');
        $oDatosCampo->setMetodoSet('setCertificado');
        $oDatosCampo->setEtiqueta(_("certificado"));
        $oDatosCampo->setTipo('texto');
        $oDatosCampo->setArgument(9);
        return $oDatosCampo;
    }

    function getDatosFirmado()
    {
        $oDatosCampo = new DatosCampo();
        $oDatosCampo->setNom_camp('firmado');
        $oDatosCampo->setMetodoGet('isFirmado');
        $oDatosCampo->setMetodoSet('setFirmado');
        $oDatosCampo->setEtiqueta(_("firmado"));
        $oDatosCampo->setTipo('check');
        return $oDatosCampo;
    }

    function getDatosF_frimado()
    {
        $oDatosCampo = new DatosCampo();
        $oDatosCampo->setNom_camp('firmado');
