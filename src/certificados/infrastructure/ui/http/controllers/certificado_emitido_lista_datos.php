...
$inicurs_ca_iso = \src\shared\domain\helpers\FuncTablasSupport::inputString($_POST, 'inicurs_ca_iso');
$fincurs_ca_iso = \src\shared\domain\helpers\FuncTablasSupport::inputString($_POST, 'fincurs_ca_iso');
