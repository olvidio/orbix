...
$Qf_enviado = \src\shared\domain\helpers\FuncTablasSupport::inputString($_POST, 'f_enviado');
...
$oCertificadoEmitido->setFirmado(\src\shared\domain\helpers\FuncTablasSupport::isTrue($Qfirmado) ?? false);
