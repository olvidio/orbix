...
/**
 *
 * Clase para gestionar la lista de objetos tipo CentroEx
 * 
 * @package orbix
 * @subpackage model
 ...
 * @created 20/11/2025
 */
class CentroExRepository implements CentroExRepositoryInterface
{

    /**$
     * @var CentroExRepositoryInterface
     */
    private CentroExRepositoryInterface $repository;

    public function __construct()
    {
        $this->repository = new PgCentroExRepository();
    }
...
/* -------------------- ENTIDAD --------------------------------------------- */
    ...
    {
        return $this->repository->Eliminar($CentroEx);
    }

	public function Guardar(CentroEx $CentroEx): bool
    {
        return $this->repository->Guardar($CentroEx);
    }
