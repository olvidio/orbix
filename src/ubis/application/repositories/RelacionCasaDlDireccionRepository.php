...
use src\ubis\infrastructure\repositories\PgCasaDlDireccionRepository;
 ...
 */
class RelacionCasaDlDireccionRepository implements RelacionUbiDireccionRepositoryInterface
{
    private RelacionUbiDireccionRepositoryInterface $repository;

    public function __construct()
    {
        $this->repository = new PgCasaDlDireccionRepository();
    }
