...
use src\ubis\infrastructure\repositories\PgCentroExDireccionRepository;
 ...
 */
class RelacionCentroExDireccionRepository implements RelacionUbiDireccionRepositoryInterface
{
    private RelacionUbiDireccionRepositoryInterface $repository;

    public function __construct()
    {
        $this->repository = new PgCentroExDireccionRepository();
    }
