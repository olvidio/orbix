...
use src\ubis\infrastructure\repositories\PgCasaExDireccionRepository;
 ...
 */
class RelacionCasaExDireccionRepository implements RelacionUbiDireccionRepositoryInterface
{
    private RelacionUbiDireccionRepositoryInterface $repository;

    public function __construct()
    {
        $this->repository = new PgCasaExDireccionRepository();
    }
