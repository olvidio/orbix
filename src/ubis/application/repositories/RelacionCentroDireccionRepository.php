...
use src\ubis\infrastructure\repositories\PgCasaDireccionRepository;
use src\ubis\infrastructure\repositories\PgCentroDireccionRepository;
 ...
 */
class RelacionCentroDireccionRepository implements RelacionUbiDireccionRepositoryInterface
{
    private RelacionUbiDireccionRepositoryInterface $repository;

    public function __construct()
    {
        $this->repository = new PgCentroDireccionRepository();
    }
