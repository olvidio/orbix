 ...
 * @created 21/11/2025
 */
interface DireccionCasaExRepositoryInterface
{
     ...
     * @return array|bool Una colección de objetos de tipo Direccion
     */
    public function getDirecciones(array $aWhere = [], array $aOperators = []): array|bool;
