 ...
 * @created 20/11/2025
 */
interface CasaDlRepositoryInterface
{
     ...
     * @return array|bool Una colección de objetos de tipo Casa
     */
    public function getCasas(array $aWhere = [], array $aOperators = []): array|bool;
