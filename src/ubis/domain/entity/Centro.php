...
class Centro
{
    ...
    /**
     * Tipo_ctr de Centro (VO código)
     */
    private ?TipoCentroCode $stipo_ctr = null;
    /**
     * Tipo_labor de Centro (VO id)
     */
     ...
     * @return Centro
     */
    public function setAllAttributes(array $aDatos): Centro
    {
