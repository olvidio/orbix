-- Equivalente sf de 202607152200_e_notas_id_nivel_plan_2026__sv.sql (sin réplica; esquemas *f / publicf).
...
--
-- Tabla padre en BD sf: publicf.e_notas (heredada por e_notas_* de cada esquema).
--
-- Mapeo id_nivel (plan 2026):
--   id_asignatura 2114: 2114 → 2312
--   id_asignatura 2211: 2212 → 2112
--   id_asignatura 2312: 2312 → 2212
...
--
-- Orden: primero 2211 (libera 2212), luego 2312 → 2212, después 2114 → 2312.

-- 2211 Latín III (plan 2026): libera el hueco 2212
