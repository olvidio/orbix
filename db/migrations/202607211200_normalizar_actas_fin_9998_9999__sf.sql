...
-- Serie sf (`publicf`). Ejecutar ANTES de repatriar (211300).
--
-- Por cada fila 9998/9999 tipo acta en publicf.e_notas:
...
BEGIN
    ...
    PERFORM public.migracion_aviso(format(
        'normalizar 9998/9999 sf: actualizadas=%s omitidas=%s sin_sigla=%s sin_f_acta=%s',
