-- Equivalente sf de 202604170000_drop_tmp_notas_tables__sv.sql (sin réplica; esquemas *f / publicf).
-- Elimina tablas temporales de notas (tmp_*) en todos los esquemas de aplicación (sf).
DO $$
DECLARE
    r RECORD;
