...
-- Serie sf. Ver docs/dev/notas_modelo_acta.md
...
BEGIN
    ...
    PERFORM public.migracion_aviso(format(
        'mover convalidaciones otra_region→dl sf: planificadas=%s insertadas=%s borradas_origen=%s sin_destino=%s omitidas_sin_dl=%s',
