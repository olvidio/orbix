...
BEGIN
    ...
    PERFORM public.migracion_aviso(format(
        'liberar 2112 hebreo plan2026 sv: candidatos=%s hebreo_aparcado=%s latin3_a_2112=%s latin4_a_2212=%s pc_a_2312=%s hebreo_a_2114=%s hebreo_sigue_2112=%s latin3_sigue_2212=%s',
