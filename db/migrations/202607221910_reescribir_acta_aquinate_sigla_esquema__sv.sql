...
-- Ej.: en I-crIv, «AQUINATE» → «crI AQUINATE».
--
...
BEGIN
    ...
    LOOP
        ...
        -- I-crI / Ch-crCh / Usca-crUsca → crI / crCh / crUsca
    ...
    PERFORM public.migracion_aviso(format('reescribir acta aquinate sv: total=%s', n_total));
END $$;
