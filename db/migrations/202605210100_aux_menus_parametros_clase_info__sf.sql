-- Equivalente sf de 202605210100_aux_menus_parametros_clase_info__sv-e.sql (sin réplica; esquemas *f / publicf).
-- aux_menus: parametros clase_info de model\ a src\...\domain\ (sf, datos, todos los esquemas *f).
