-- Equivalente sf de 202608311300_e_notas_id_nivel_1230_a_2430__sv.sql
...
-- se deja sin cambiar.
--
-- Tabla padre en BD sf: publicf.e_notas (heredada por e_notas_*).
...
BEGIN
    ...
    PERFORM public.migracion_aviso(format(
        'e_notas id_nivel 1230-1232 → 2430+ sf: actualizadas=%s sin_hueco_2430_2433=%s',
        n_ok, n_sin_hueco
    ));
END $$;
