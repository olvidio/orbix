-- Equivalente sf de 202606040000_drop_p_de_paso_out__sv.sql (sin réplica; esquemas *f / publicf).
-- Elimina p_de_paso_out y el trigger update_p_de_paso_out_trigger en publicf y esquemas *f (sf, datos).
DO $$
DECLARE
...
BEGIN
    FOR trigger_record IN
        ...
        WHERE p.proname = 'update_p_de_paso_out'
          ...
          AND (n.nspname = 'publicf' OR n.nspname LIKE '%f')
    LOOP
        EXECUTE format(
