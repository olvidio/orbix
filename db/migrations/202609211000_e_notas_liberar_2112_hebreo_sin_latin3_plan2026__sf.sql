-- Equivalente sf de 202609211000_e_notas_liberar_2112_hebreo_sin_latin3_plan2026__sv.sql
...
BEGIN
    ...
    PERFORM public.migracion_aviso(format(
        'liberar 2112 hebreo sin latin3 plan2026 sf: candidatos=%s hebreo_aparcado=%s hebreo_a_2114=%s sin_hueco=%s hebreo_sigue_2112=%s',
