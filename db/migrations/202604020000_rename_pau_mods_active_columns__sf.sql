-- Equivalente sf de 202604020000_rename_pau_mods_active_columns__sv-e.sql (sin réplica; esquemas *f / publicf).
-- aux_usuarios: id_pau → csv_id_pau en todos los esquemas sf (idempotente; SQL autónomo).
DO $$
DECLARE
    r RECORD;
BEGIN
