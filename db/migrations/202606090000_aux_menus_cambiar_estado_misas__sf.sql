-- Equivalente sf de 202606090000_aux_menus_cambiar_estado_misas__sv-e.sql (sin réplica; esquemas *f / publicf).
-- aux_menus: entrada "Cambiar estado" (misas) en todos los esquemas sf (datos, idempotente).
