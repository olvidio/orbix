...
Guarda los cambios a un `TipoDossier`. Sustituye al case `guardar` del antiguo `apps/dossiers/controller/perm_dossier_update.php`.
...
|-------|------|--------|-------------|-------|
| `Permiso_escritura` | `mixed` | application | No | application |
| `Permiso_lectura` | `mixed` | application | No | application |
