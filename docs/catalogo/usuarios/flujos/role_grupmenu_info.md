...
# Flujo - Gestionar Role Grupmenu Info

Propuesta generada automaticamente desde la capacidad `usuarios.role_grupmenu_info.gestionar` y sus pantallas relacionadas.
