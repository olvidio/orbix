...
# Flujo - Gestionar Usuario 2fa Info

Propuesta generada automaticamente desde la capacidad `usuarios.usuario_2fa_info.gestionar` y sus pantallas relacionadas.
