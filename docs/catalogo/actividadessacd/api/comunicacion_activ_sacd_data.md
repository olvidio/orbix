...
respuesta_data: ["que:string, id_nom: int, propuesta: string, inicioIso: string, finIso: string, periodo_txt: string"]
...
Endpoint backend: construye el listado de atencion de actividades a comunicar a los sacd.
...
- Payload en `data` (schema `actividadessacd_ComunicacionActividadesSacdDataData`):
  - `que` (`string, id_nom: int, propuesta: string, inicioIso: string, finIso: string, periodo_txt: string`)
