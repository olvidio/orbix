...
- `docs/legacy/obix/13. Sistema.md`
- `docs/legacy/obix/procesos/mapa_procesos_select.md`
...
- `docs/legacy/obix/menus.csv`, `log/menus/comun.sql`,
...
- `docs/legacy/obix/procesos/mapa_fases_activ_cambio.md`
