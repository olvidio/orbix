...
- Menus: `log/menus/comun.sql`, `proves/aux_metamenus.csv`,
  `docs/legacy/obix/menus.csv` apuntan a 3
  entradas (gestion_plazas, incorporar_peticion, plazas_balance_que).
- Docs: `docs/legacy/obix/2.` (numerarios),
...
- `log/menus/comun.sql`, `proves/aux_metamenus.csv`,
  `docs/legacy/obix/menus.csv`: rutas → `frontend/actividadplazas/controller/...`.
- `docs/legacy/obix/2. Gestión de Numerarios (n).md`,
