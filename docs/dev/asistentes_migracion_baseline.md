...
- `proves/aux_metamenus.csv`, `log/menus/comun.sql`,
  `docs/legacy/obix/menus.csv` y
  `docs/dev/reports/orbix_runtime_link_report.json` actualizados en bloque.
...
- `apps/actividadestudios/...` (ya migrado): referencias viejas en
  docs.
- Tablas de menu (`docs/legacy/obix/menus.csv`,
...
[`docs/dev/REFACTOR_INDICE.md`](REFACTOR_INDICE.md).
