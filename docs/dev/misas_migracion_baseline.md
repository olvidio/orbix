...
13. ~~**Slice 11 — Limpieza y menus.** Actualizar `docs/legacy/obix/menus.csv`, `proves/aux_metamenus.csv` y otros consumidores.~~ **Completado:** ver seccion Slice 11.
...
- **`docs/legacy/obix/menus.csv`** y **`proves/aux_metamenus.csv`:** entrada del modulo misas → `frontend/misas/controller/misas_index.php`.
...
- **`docs/legacy/obix/8. dre (personas, actividades y encargos).md`:** ruta del menu misas actualizada.
