...
- [ ] Ejecutar: **comun** `211100` → `211110`; luego **sv/sf** `211120` → … → **`211240`** → `211250` → `211300` → … → `222000` → **`271800`** → **`271900`** → **`272000`** → **`281100`**. Ampliar filas del mapa en comun si el diag marca `sin_mapa`. Altas nuevas de 9998/9999 vía `ActaFinCicloInsert`.  
