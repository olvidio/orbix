...
- Objetivo: `src/` **no importa** `HashF`. Aún hay excepciones en menus, encargossacd y notas; se migran en slices separados, no como parte de este cambio de nombre.
...
3. **Cerrar las excepciones por módulo**: menus, encargossacd y notas son slices separados.
