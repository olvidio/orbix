...
subtipo: "flujo"
modulo: "inventario"
titulo: "Lista Docs De Egm"
flujo: "inventario.lista_docs_de_egm.gestionar.flujo"
preguntas: ["Como ejecutar en Lista Docs De Egm?"]
...
source: "docs/catalogo/inventario/flujos/lista_docs_de_egm.md"
estado_revision: "generado"
---

# Ayuda IA - Lista Docs De Egm

Usa este documento para responder preguntas de usuario sobre como trabajar con `Lista Docs De Egm`.

## Cuando Usar Esta Ayuda

Responder con esta ayuda cuando el usuario pregunte por:
- Como ejecutar en Lista Docs De Egm?
