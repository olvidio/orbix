...
preguntas: ["Como eliminar en Perm Activ?", "Como guardar en Perm Activ?", "Como consultar el listado en Perm Activ?"]
...
source: "docs/catalogo/usuarios/flujos/perm_activ.md"
estado_revision: "generado"
---

# Ayuda IA - Perm Activ

Usa este documento para responder preguntas de usuario sobre como trabajar con `Perm Activ`.

## Cuando Usar Esta Ayuda

Responder con esta ayuda cuando el usuario pregunte por:
- Como eliminar en Perm Activ?
- Como guardar en Perm Activ?
- Como consultar el listado en Perm Activ?
