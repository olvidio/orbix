...
- `documentacion/Documentacion_Obix/menus.csv` (3 entradas).
...
- `ReadLints` en `frontend/dossiers`, `src/dossiers` y consumidores:
  sin errores.
- `rg 'apps/dossiers'` fuera de `documentacion/` y `languages/`: solo
...
- `proves/aux_metamenus.csv` (id 121)
- `log/menus/comun.sql` (id 121)
- `documentacion/Documentacion_Obix/menus.csv` (3 entradas: personas / ubis / actividades)
...
- Actualizar menus (`proves/aux_metamenus.csv`, `log/menus/comun.sql`,
  `documentacion/Documentacion_Obix/menus.csv`) para apuntar a
