...
flowchart TD
    ...
    apps_ubis_controller_list_ctr_php(["list_ctr.php"]):::controller --> apps_ubis_view_list_ctr_phtml[["list_ctr.phtml"]]:::vista
    apps_ubis_view_list_ctr_phtml --> apps_ubis_controller_list_ctr_php(["list_ctr.php"]):::controller
    apps_ubis_view_list_ctr_phtml --> apps_ubis_controller_home_ubis_php(["home_ubis.php"]):::controller
    apps_ubis_view_list_ctr_phtml --> apps_ubis_controller_trasladar_ubis_php(["trasladar_ubis.php"]):::controller
    apps_ubis_view_list_ctr_phtml --> apps_ubis_controller_delegacion_que_php(["delegacion_que.php"]):::controller
    %% DESTÍ NO RESOLT des de apps_ubis_view_list_ctr_phtml: $h2 [DESTÍ NO RESOLT]
    %% DESTÍ NO RESOLT des de apps_ubis_view_list_ctr_phtml: $oHash1->getCamposHtml(); [DESTÍ NO RESOLT]
    ...
    apps_ubis_controller_delegacion_que_php(["delegacion_que.php"]):::controller --> apps_ubis_view_delegaciones_html_twig[["delegaciones.html.twig"]]:::vista
