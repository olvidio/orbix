...
flowchart TD
    ...
    frontend_inventario_controller_equipajes_nuevo_php(["equipajes_nuevo.php"]):::controller --> frontend_inventario_view_equipajes_nuevo_phtml[["equipajes_nuevo.phtml"]]:::vista
    frontend_inventario_view_equipajes_nuevo_phtml --> frontend_inventario_controller_equipajes_form_nuevo_php(["equipajes_form_nuevo.php"]):::controller
    frontend_inventario_view_equipajes_nuevo_phtml --> frontend_inventario_controller_equipajes_casas_posibles_php(["equipajes_casas_posibles.php"]):::controller
    frontend_inventario_view_equipajes_nuevo_phtml --> frontend_inventario_controller_equipajes_lista_activ_periodo_php(["equipajes_lista_activ_periodo.php"]):::controller
    frontend_inventario_view_equipajes_nuevo_phtml --> src_inventario_infrastructure_controllers_equipajes_nuevo_guardar_php(["equipajes_nuevo_guardar.php"]):::controller
    frontend_inventario_view_equipajes_nuevo_phtml --> frontend_inventario_controller_equipajes_ver_php(["equipajes_ver.php"]):::controller
    %% DESTÍ NO RESOLT des de frontend_inventario_view_equipajes_nuevo_phtml: $oHash->getCamposHtml() [DESTÍ NO RESOLT]
    frontend_inventario_controller_equipajes_form_nuevo_php(["equipajes_form_nuevo.php"]):::controller --> frontend_inventario_view_equipajes_form_nuevo_phtml[["equipajes_form_nuevo.phtml"]]:::vista
    frontend_inventario_controller_equipajes_lista_activ_periodo_php(["equipajes_lista_activ_periodo.php"]):::controller --> frontend_inventario_view_equipajes_lista_activ_periodo_phtml[["equipajes_lista_activ_periodo.phtml"]]:::vista
    %% DESTÍ NO RESOLT des de frontend_inventario_view_equipajes_lista_activ_periodo_phtml: $oHash->getCamposHtml() [DESTÍ NO RESOLT]
