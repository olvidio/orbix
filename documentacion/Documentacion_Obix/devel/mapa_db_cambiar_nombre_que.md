...
flowchart TD
    ...
    frontend_devel_db_admin_view_db_cambiar_nombre_que_phtml --> frontend_devel_db_admin_controller_db_verificar_renombrar_esquema_php(["db_verificar_renombrar_esquema.php"]):::controller
