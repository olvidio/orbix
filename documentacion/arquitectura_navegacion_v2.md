...
guiándose por `php scripts/audit_posicion_nav_migration.php` para inventariar lo pendiente.
...
6. Cada fase termina ejecutando los escenarios de §8 que apliquen y
   `php scripts/audit_posicion_nav_migration.php` para verificar que las pantallas
