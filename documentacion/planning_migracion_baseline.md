...
- `documentacion/Documentacion_Obix/menus.csv` — 31 entradas que apuntan a `apps/planning/controller/*.php` con distintos parametros segun rol.
...
- Actualizar `documentacion/Documentacion_Obix/menus.csv`, `proves/aux_metamenus.csv` y referencias JS a rutas `frontend/`.
