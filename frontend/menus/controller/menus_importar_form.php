...
$url_backend = '/src/menus/infrastructure/ui/http/controllers/lista_templates.php';
$data = PostRequest::getDataFromUrl($url_backend);

$a_opciones = $data['a_opciones'];
$oDesplTemplates = new Desplegable('id_template_menu', $a_opciones, '', true);

$url = ConfigGlobal::getWeb() . '/src/menus/infrastructure/ui/http/controllers/menus_importar.php';
$oHash = new Hash();
$oHash->setUrl($url);
