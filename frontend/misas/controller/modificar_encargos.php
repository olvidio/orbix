...
$oDesplOrden->setOpciones(MisasDesplegableSupport::opciones($a_orden));
...
AjaxJsonSupport::renderPhtml('frontend\\misas\\controller', 'modificar_encargos.phtml', $a_campos);
