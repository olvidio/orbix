...
$url_backend = '/src/inventario/lista_docs_asignar_dlb';
$a_campos_backend = [
    'id_tipo_doc' => $Qid_tipo_doc,
    'sel' => $a_sel,
];
...
$a_cabeceras = [ucfirst(_('delegación')), $num_txt];
...
$url_guardar = AppUrlConfig::srcBrowserUrl('/src/inventario/doc_asignar_dlb_guardar') . '?';
