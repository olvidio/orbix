...
final class CertificadosMpdfRender
{
    ...
    public static function fromPayload(array $payload): array
    {
        return [
            ...
            'txt_superavit' => \frontend\shared\helpers\PayloadCoercion::string($payload['txt_superavit'] ?? ''),
            'curso_filosofia' => \frontend\shared\helpers\PayloadCoercion::string($payload['curso_filosofia'] ?? ''),
            'any_I' => \frontend\shared\helpers\PayloadCoercion::string($payload['any_I'] ?? ''),
            'ECTS' => \frontend\shared\helpers\PayloadCoercion::string($payload['ECTS'] ?? ''),
            'iudicium' => \frontend\shared\helpers\PayloadCoercion::string($payload['iudicium'] ?? ''),
            'curso_teologia' => \frontend\shared\helpers\PayloadCoercion::string($payload['curso_teologia'] ?? ''),
            'pie_ects' => \frontend\shared\helpers\PayloadCoercion::string($payload['pie_ects'] ?? ''),
            'any_II' => \frontend\shared\helpers\PayloadCoercion::string($payload['any_II'] ?? ''),
            'any_III' => \frontend\shared\helpers\PayloadCoercion::string($payload['any_III'] ?? ''),
            'any_IV' => \frontend\shared\helpers\PayloadCoercion::string($payload['any_IV'] ?? ''),
            'titulo_1' => \frontend\shared\helpers\PayloadCoercion::string($payload['titulo_1'] ?? ''),
            'titulo_2' => \frontend\shared\helpers\PayloadCoercion::string($payload['titulo_2'] ?? ''),
            'titulo_3' => \frontend\shared\helpers\PayloadCoercion::string($payload['titulo_3'] ?? ''),
            'infra' => \frontend\shared\helpers\PayloadCoercion::string($payload['infra'] ?? ''),
