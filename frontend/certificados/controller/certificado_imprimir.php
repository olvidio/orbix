...
$pag_certificado_2_pdf = ConfigGlobal::getWeb() . '/frontend/certificados/controller/certificado_2_mpdf.php';
$oHash = new Hash();
$oHash->setUrl($pag_certificado_2_pdf);
$oHash->setCamposForm('id_item!guardar');
$h = $oHash->linkSinVal();

$pag_certificado_eliminar = ConfigGlobal::getWeb() . '/src/certificados/infrastructure/controllers/certificado_delete.php';
$oHash_e = new Hash();
