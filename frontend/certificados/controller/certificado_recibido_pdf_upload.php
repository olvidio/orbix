...
function upload(): array
{
    ...
    if ($tmpFilePath !== "") {
        ...
        $oCertificadoRecibido = (new CertificadoRecibidoUpload)->uploadNew($Qid_item, $Qid_nom, $contenido_doc, $Qidioma, $Qcertificado, $Qfirmado, $oF_certificado, $oF_recibido, $Qdestino);
