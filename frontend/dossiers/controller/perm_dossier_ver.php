 ...
 *
 * Migrado desde `apps/dossiers/controller/perm_dossier_ver.php`.
 */
...
$go_to = Hash::link(ConfigGlobal::getWeb() . '/frontend/dossiers/controller/perm_dossiers.php?' . http_build_query($a_dataUrl));
