...
switch ($Qque) {
    ...
    case 'lista':
        ...
        echo render_contribucion_no_duerme_lista_html($data);
        break;
    case 'form_default':
...
/**
 * Renderiza el HTML del listado de contribución_no_duerme para `#div_tabla`.
 *
 * @param array{default?: string, excepciones?: array<int, array{id_tipo_activ: string, etiqueta: string, valor: string}>} $data
 */
function render_contribucion_no_duerme_lista_html(array $data): string
{
