...
class ModuloInstalado Extends core\ClasePropiedades {
	...
	public function DBGuardar() {
		...
		if ($bInsert === false) {
			...
			$campos="(id_schema,id_mod,status,param)";
			$valores="(:id_schema,:id_mod,:status,:param)";		
	...
	function getDatosCampos() {
		...
		$oModuloInstaladoSet->add($this->getDatosId_schema());
	...
	/**
	 * Recupera les propietats de l'atribut iid_schema de ModuloInstalado
	...
	function getDatosParam() {
		...
		$oDatosCampo->setEtiqueta(_("param"));
		return $oDatosCampo;
	}
}