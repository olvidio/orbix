 ...
 */
/**
 * Classe que implementa l'entitat a_sacd_textos
 *
 * @package orbix
 * @subpackage model
 * @author Daniel Serrabou
...
class AtnActivSacdTexto Extends core\ClasePropiedades {
	...
	/**
	 * Recupera tots els atributs de AtnActivSacdTexto en un array
	 *
	 * @return array aDades
	 */
	function getTot() {
	...
	/**
	 * Recupera las claus primàries de AtnActivSacdTexto en un array
	 *
	...
	/**
	 * Estableix las claus primàries de AtnActivSacdTexto  en un array
	 *
	 * @return array aPrimary_key
	 */
	...
	/**
	 * Recupera l'atribut iid_item de AtnActivSacdTexto
	 *
	...
	/**
	 * estableix el valor de l'atribut iid_item de AtnActivSacdTexto
	 *
	...
	/**
	 * Recupera l'atribut sidioma de AtnActivSacdTexto
	 *
	...
	/**
	 * estableix el valor de l'atribut sidioma de AtnActivSacdTexto
	 *
	...
	/**
	 * Recupera l'atribut sclave de AtnActivSacdTexto
	 *
	...
	/**
	 * estableix el valor de l'atribut sclave de AtnActivSacdTexto
	 *
	...
	/**
	 * Recupera l'atribut stexto de AtnActivSacdTexto
	 *
	...
	/**
	 * estableix el valor de l'atribut stexto de AtnActivSacdTexto
	 *
