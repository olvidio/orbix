...
$GesAsignaturas = new asignaturas\model\GestorAsignatura();
...
<table >
<thead><th class=titulo_inv colspan=4><?php echo ucfirst(_("búsqueda de personas por asignatura")); ?></th></thead>
<tfoot>
<tr>
	<th colspan=4><input type="button" onclick="fnjs_enviar_formulario('#frm_asig_altan1')" id="ok" name="ok" value="<?php echo ucfirst(_("buscar")); ?>"  class="btn_ok">
	<input TYPE="reset" value="<?php echo ucfirst(_("borrar")); ?>"></th>
</tr>
</tfoot>
<tbody>
...
<tr>
	<td class=etiqueta><b><?php echo ucfirst(_("asignatura")); ?></b></td> 
