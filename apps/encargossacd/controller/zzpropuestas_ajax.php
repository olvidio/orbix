...
use encargossacd\legacy\GestorPropuestaEncargoSacdHorario;
use encargossacd\legacy\GestorPropuestaEncargosSacd;
use encargossacd\legacy\GestorPropuestas;
use encargossacd\legacy\PropuestaEncargoSacdHorario;
...
switch ($Qque) {
    case "lista_sacd":
        ...
        /* lista sacd posibles */
        $aOpciones = $PersonaSacdRepository->getArraySacd("AND id_tabla ~ '^(a|n|sss)$'");
        $oDesplSacd = new Desplegable();
        $oDesplSacd->setOpciones($aOpciones);
        $html = '';
    ...
    case "dedicacion":
        ...
        $oPersonaSacd = $PersonaSacdRepository->findById($Qid_sacd);
