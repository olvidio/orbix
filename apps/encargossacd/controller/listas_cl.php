...
<table>
    <tr>
        ...
        <td class=derecha><?= $cabecera_right ?></td>
    </tr>
    <tr>
        <td></td>
        <td class=derecha><?= $cabecera_right_2 ?></td>
    </tr>
</table>
<table>
    <?php
    ...
    foreach ($oDBSt_prop->fetchAll() as $cargos) {
        ...
        if ($Centre != $cargos["nombre_ubi"]) {
            ...
            <tr style="font-weight : bold;">
                <td height="30" colspan="5" valign="TOP"><?php echo "$nombre_ubi"; ?></td>
                <td></td>
                <td align="LEFT"><?php echo "$elencum"; ?></td>
            </tr>
        <?php } ?>
        <tr>
            <td width='40' nowrap><?php echo "$cargo"; ?></td>
            <td></td><!-- Añado una celda para que al pasarlo a sólo texto haya 2 espacios según cr 16/90,6 -->
        ...
        <?php
        if ($cargos["nombre_ubi"]) {
            $Centre = $cargos["nombre_ubi"];
        }
    }
    ?>
</table>
<table>
    <tr>
        ...
        <td class=derecha><?= $lugar_fecha ?></td>
    </tr>
</table>
