			...
			foreach ($cPersonas as $oPersonaNAgd) {
				...
				*/
				...
				if ($permiso_sf=="si") {
					...
					if ($sf_ctr[3]==1) { $sf_txt.=", ".sprintf("%s centro sf",$sf_ctr[3]); } elseif ($sf_ctr[3]>1) { $sf_txt.=", ".sprintf("%s centros sf",$sf_ctr[3]); }
					if ($sf_ctr[4]==1) { $sf_txt.=", ".sprintf("suplente de %s centro sf",$sf_ctr[4]); } elseif ($sf_ctr[4]>1) { $sf_txt.=", ".sprintf("suplente de %s centros sf",$sf_ctr[4]); }
					if ($sf_cgi[3]==1) { $sf_txt.=", ".sprintf("atiende %s colegio sf",$sf_cgi[3]); } elseif ($sf_cgi[3]>1) { $sf_txt.=", ".sprintf("atiende %s colegios sf",$sf_cgi[3]); }
					if ($sf_cgi[4]==1) { $sf_txt.=", ".sprintf("colabora con %s colegio sf",$sf_cgi[4]); } elseif ($sf_cgi[4]>1) { $sf_txt.=", ".sprintf("colabora con %s colegios sf",$sf_cgi[4]); }
					$sf_txt=substr($sf_txt,2);
				}
