...
<form id="modifica" name="modifica" action="">
    ...
    <table>
        <tr>
            <th class="titulo_inv"><?php echo ucfirst($ap_nom); ?></th>
        </tr>
        <tr>
            <th class="titulo_inv"><?php echo ucfirst($titulo); ?></th>
        </tr>
    </table>
    <br>
    <table>
        ...
        <tr>
            ...
            <td><input class=contenido size="11" id="h_ini" name="h_ini" value="<?php echo $h_ini ?>">
            <td class=etiqueta><?php echo ucfirst(_("hora fin")); ?>:</td>
            <td><input class=contenido size="11" id="h_fin" name="h_fin" value="<?php echo $h_fin ?>">
        </tr>
        <tr>
