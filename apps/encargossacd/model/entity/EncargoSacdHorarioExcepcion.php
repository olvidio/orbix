...
/**
 * Clase que implementa la entidad encargo_sacd_horario_excepcion
 *
 * @package orbix
 * @subpackage model
 * @author Daniel Serrabou
 ...
 * @created 11/01/2019
 */
class EncargoSacdHorarioExcepcion extends ClasePropiedades
{
    /* ATRIBUTOS ----------------------------------------------------------------- */
    ...
    function __construct($a_id = '')
    {
        ...
        if (is_array($a_id)) {
            ...
            foreach ($a_id as $nom_id => $val_id) {
                if (($nom_id === 'id_item_ex') && $val_id !== '') $this->iid_item_ex = (int)$val_id;
    ...
    public function DBGuardar()
    {
        ...
        if ($bInsert === FALSE) {
            ...
            $this->iid_item_ex = $oDbl->lastInsertId('encargo_sacd_horario_excepcion_id_item_ex_seq');
        }
    ...
    /**
     * Recupera todos los atributos de EncargoSacdHorarioExcepcion en un array
     *
     * @return array aDades
     */
    function getTot()
    ...
    /**
     * Recupera la clave primaria de EncargoSacdHorarioExcepcion en un array
     *
    ...
    /**
     * Establece la clave primaria de EncargoSacdHorarioExcepcion en un array
     *
     * @return array aPrimary_key
     */
    ...
    /**
     * Recupera el atributo iid_item_ex de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo iid_item_ex de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo iid_enc de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo iid_enc de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo iid_item_h de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo iid_item_h de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo df_ini de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo df_ini de EncargoSacdHorarioExcepcion
    ...
    /**
     * Recupera el atributo df_fin de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo df_fin de EncargoSacdHorarioExcepcion
    ...
    /**
     * Recupera el atributo sdesc_ex de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo sdesc_ex de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo bhorario de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo bhorario de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo sdia_ref de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo sdia_ref de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo idia_num de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo idia_num de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo smas_menos de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo smas_menos de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo idia_inc de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo idia_inc de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo th_ini de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo th_ini de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo th_fin de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Establece el valor del atributo th_fin de EncargoSacdHorarioExcepcion
     *
    ...
    /**
     * Recupera el atributo imes de EncargoSacdHorarioExcepcion
     *
     * @return integer imes
     */
    function getMes()
    ...
    /**
     * Establece el valor del atributo imes de EncargoSacdHorarioExcepcion
     *
    ...
    {
        $oEncargoSacdHorarioExcepcionSet = new Set();
    ...
    {
        $nom_tabla = $this->getNomTabla();
        $oDatosCampo = new DatosCampo(array('nom_tabla' => $nom_tabla, 'nom_camp' => 'id_item_h'));
    ...
    {
        $nom_tabla = $this->getNomTabla();
        $oDatosCampo = new DatosCampo(array('nom_tabla' => $nom_tabla, 'nom_camp' => 'desc_ex'));
    ...
    {
        $nom_tabla = $this->getNomTabla();
        $oDatosCampo = new DatosCampo(array('nom_tabla' => $nom_tabla, 'nom_camp' => 'horario'));
