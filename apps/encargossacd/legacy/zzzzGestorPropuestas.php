...
namespace encargossacd\legacy;

use encargossacd\model\EncargoSacd;
use encargossacd\model\EncargoSacdHorario;
use encargossacd\model\EncargoTipo;
use encargossacd\model\GestorEncargo;
use encargossacd\model\GestorEncargoSacdHorario;
...
class GestorPropuestas
{
    ...
    public function getEncargosUbiSimple($id_ubi)
    {
        ...
        foreach ($cEncargos as $oEncargo) {
            ...
            $oPersonaSacdNew = $PersonaSacdRepository->findById($id_sacd_new);
