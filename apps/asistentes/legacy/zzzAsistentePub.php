...
class AsistentePub extends ClasePropiedades
{
     ...
     */
    public function getRepoAsistente(string $id_nom, $id_activ)
    {
        $msg_err = '';
        ...
        if ($dl == ConfigGlobal::mi_delef()) {
            switch ($obj_persona) {
                ...
                case 'PersonaSSSC':
                case 'PersonaDl':
                    $clase = 'asistentes\\legacy\\AsistenteDl';
                    break;
                case 'PersonaIn':
                    // Supongo que sólo debería modificar la dl origen.
                    //$clase = 'asistentes\\legacy\\AsistenteIn';
                    ...
                    break;
                case 'PersonaEx':
                    $clase = 'asistentes\\legacy\\AsistenteEx';
                    break;
            }
        } else {
            ...
            if ($obj_persona === 'PersonaEx') {
                ...
                $clase = 'asistentes\\legacy\\AsistenteOut';
            }
        }
        return new $clase;
    }
