...
<table>
<thead>
<tr><th colspan=7><?php echo ucfirst (_("escoger un centro")); ?></th></tr>
</thead>
<tfoot>
	<tr class=botones><td colspan="7"><input TYPE="button" onclick="fnjs_enviar_formulario('#lista');" VALUE="<?= ucfirst(_("listar")) ?>"></td>
	</tr>
</tfoot>
<tbody>
	<tr>
