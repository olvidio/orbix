...
$go_to=web\Hash::link(core\ConfigGlobal::getWeb()."/apps/dossiers/controller/dossiers_ver.php?pau=${_POST['pau']}&id_pau=${_POST['id_pau']}&obj_pau=${_POST['obj_pau']}&id_dossier=${_POST['id_dossier']}&permiso=${_POST['permiso']}&depende=${_POST['depende']}");
