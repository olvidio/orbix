...
fnjs_modificar=function(formulario){
	...
	if (rta==1) {
		$('#mod').val("editar");
  		$(formulario).attr('action',"apps/dossiers/controller/form_1011.php");
...
fnjs_borrar=function(formulario){
	...
	if (rta==1) {
		...
		if (seguro) {
			$('#mod').val("eliminar");
	  		$(formulario).attr('action',"apps/dossiers/controller/update_1011.php");
	  		fnjs_enviar_formulario(formulario,'#ficha_personas');
		}
  	}
}
...
if ($permiso==3) {
	$pagina="apps/dossiers/controller/form_1011.php?pau=$pau&id_pau=$id_pau&mod=nuevo&go_to=$go_to";
	?>
	<br><table><tr>
