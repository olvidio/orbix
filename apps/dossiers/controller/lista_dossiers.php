...
foreach ($cTipoDossier as $oTipoDossier) {
	...
	$a_filas[$i]['href_abrir']=web\Hash::link(core\ConfigGlobal::getWeb().'/apps/dossiers/controller/dossier_abrir.php?'.http_build_query(array('pau'=>$pau,'id_pau'=>$id_pau,'obj_pau'=>$obj_pau,'id_dossier'=>$id_dossier,'tabla_to'=>$tabla_to,'permiso'=>$perm_a)));
