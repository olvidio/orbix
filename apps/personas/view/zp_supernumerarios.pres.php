...
<script>
    ...
    $(function () {
        $("#f_estado_<?= $tabla[$f] . $r ?>").datepicker();
    });
    $(function () {
        $("#f_cfi_<?= $tabla[$f] . $r ?>").datepicker();
    });
    $(function () {
        $("#f_num_hijos_<?= $tabla[$f] . $r ?>").datepicker();
    });
...
<input class=contenido type="hidden" name="id_ctr_<?= $tabla[$f] . $r; ?>" value="<?= $id_ctr ?>"
       title="<?= $id_ctr_help; ?>">
<input class=contenido type="hidden" name="id_ctr_cr_<?= $tabla[$f] . $r; ?>" value="<?= $id_ctr_cr ?>"
       title="<?= $id_ctr_cr_help; ?>">
    ...
    <tr>
        ...
        <table id="centro" border=1 style='display:none;'>
            ...
            <tr>
                ...
                <td colspan="3"><span class=etiqueta
                ...
                <select class=contenido name="estado_<?= $tabla[$f] . $r; ?>" title="<?= $estado_help; ?>">
                    ...
                    <option value="s" <?php if ($estado == "s") {
                        echo "selected";
                    } ?> >s
                    </option>
                    <option value="c" <?php if ($estado == "c") {
                        echo "selected";
                    } ?> >c
                    </option>
                    <option value="v" <?php if ($estado == "v") {
                        echo "selected";
                    } ?> >v
                    </option>
                </select></td>
