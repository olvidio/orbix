...
class Preferencia Extends core\ClasePropiedades {
	...
	public function DBGuardar() {
		...
		if ($bInsert === false) {
			...
			if (($qRs = $oDbl->prepare("UPDATE $nom_tabla SET $update WHERE id_usuario='$this->iid_usuario' AND tipo='$this->stipo'")) === false) {
	...
	public function DBCarregar($que=null) {
		...
		if (isset($this->iid_usuario) && isset($this->stipo)) {
			if (($qRs = $oDbl->query("SELECT * FROM $nom_tabla WHERE id_usuario='$this->iid_usuario' AND tipo='$this->stipo'")) === false) {
	...
	public function DBEliminar() {
		$oDbl = $this->getoDbl();
		$nom_tabla = $this->getNomTabla();
		if (($qRs = $oDbl->exec("DELETE FROM $nom_tabla WHERE id_usuario='$this->iid_usuario' AND tipo='$this->stipo'")) === false) {
