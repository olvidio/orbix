...
class CertificadoDlSelect
{
     ...
     * @param int $Qid_dossier
     * @return array
     */
    public static function getCamposVista(string $Qcertificado, mixed $Qid_sel, mixed $Qscroll_id, int $Qid_dossier): array
    {
