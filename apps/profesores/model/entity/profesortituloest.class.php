...
class ProfesorTituloEst Extends core\ClasePropiedades {
	...
	public function DBGuardar() {
		...
		$aDades['eclesiastico'] = ($aDades['eclesiastico'] === 't')? 'true' : $aDades['eclesiastico'];
		if ( filter_var( $aDades['eclesiastico'], FILTER_VALIDATE_BOOLEAN)) { $aDades['eclesiastico']='t'; } else { $aDades['eclesiastico']='f'; }
	...
	/**
	 * Estableix las claus primàries de ProfesorTituloEst en un array
	 *
	 * @return array aPrimary_key
	 */
