...
if (empty($Qque)) {
    ...
    <table border=1>
        <tr>
            <th></th>
            <th></th>
            <th><?= _("días ocupados") ?></th>
            <th>%</th>
            <th><?= _("nº días x nº asistentes (previsto)") ?></th>
            <th>%</th>
            <th><?= _("nº días x nº asistentes (real)") ?></th>
            <th>%</th>
            <th><?= _("ingresos previstos acumulados") ?></th>
            <th>%</th>
            <th><?= _("ingresos reales acumulados") ?></th>
            <th>%</th>
            <th><?= _("gastos reales") ?></th>
            <th>%</th>
            <th><?= _("aportación real dl") ?></th>
            <th><?= _("superávit") ?></th>
        <tr>
            <?php
            foreach ($a_resumen
        ...
        <tr>
            <td><?= $row[0]['nom'] ?></td>
            <td>dlb</td>
            <td class='derecha'><?= $row[1]['dias'] ?></td>
            <td class='derecha'><?= $row[1]['dias%'] ?></td>
            <td class='derecha'><?= $row[1]['asist_prev'] ?></td>
            <td class='derecha'><?= $row[1]['asist_prev%'] ?></td>
            <td class='derecha'><?= $row[1]['asist'] ?></td>
            <td class='derecha'><?= $row[1]['asist%'] ?></td>
            <td class='derecha'><?= $row[1]['in_prev_acu'] ?>
            <td class='derecha'><?= $row[1]['in_prev_acu%'] ?></td>
            <td class='derecha'><?= $row[1]['in_acu'] ?></td>
            <td class='derecha'><?= $row[1]['in_acu%'] ?></td>
            <td class='derecha'><?= $row[1]['gasto'] ?></td>
            <td class='derecha'><?= $row[1]['gasto%'] ?></td>
            <td class='derecha'><?= $row[1]['aportacion'] ?></td>
            <td class='derecha'><?= $row[1]['superavit'] ?></td>

        </tr>
        <tr>
            <td><span id='span_detalles_<?= $id_ubi ?>_0' class=link onclick="fnjs_detalles(<?= $id_ubi ?>,0)">
    			<p><?= _("mostrar detalles") ?></p>
    			<p style="display: none"><?= _("ocultar detalles") ?></p>
    		</span></td>
            <td>dlbf</td>
            <td class='derecha'><?= $row[2]['dias'] ?></td>
            <td class='derecha'><?= $row[2]['dias%'] ?></td>
            <td class='derecha'><?= $row[2]['asist_prev'] ?></td>
            <td class='derecha'><?= $row[2]['asist_prev%'] ?></td>
            <td class='derecha'><?= $row[2]['asist'] ?></td>
            <td class='derecha'><?= $row[2]['asist%'] ?></td>
            <td class='derecha'><?= $row[2]['in_prev_acu'] ?></td>
            <td class='derecha'><?= $row[2]['in_prev_acu%'] ?></td>
            <td class='derecha'><?= $row[2]['in_acu'] ?></td>
            <td class='derecha'><?= $row[2]['in_acu%'] ?></td>
            <td class='derecha'><?= $row[2]['gasto'] ?></td>
            <td class='derecha'><?= $row[2]['gasto%'] ?></td>
            <td class='derecha'><?= $row[2]['aportacion'] ?></td>
            <td class='derecha'><?= $row[2]['superavit'] ?></td>

        </tr>
        <tr>
            <td></td>
            <td>totales</td>
            <td class='derecha'><?= $row[1]['dias'] + $row[2]['dias'] ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= $row[1]['asist_prev'] + $row[2]['asist_prev'] ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= $row[1]['asist'] + $row[2]['asist'] ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= round(($row[1]['in_prev_acu'] + $row[2]['in_prev_acu']), 2) ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= round(($row[1]['in_acu'] + $row[2]['in_acu']), 2) ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= $row[0]['gasto'] ?></td>
            <td class='derecha'></td>
            <td></td>
            <td class='derecha'><?= round(($row[1]['superavit'] + $row[2]['superavit']), 2) ?></td>
        ...
        ?>
        <tr>
            <td rowspan=3><?= _("totales") ?></td>
            <td>dlb</td>
            <td class='derecha'><?= $tot[1]['dias'] ?></td>
            <td class='derecha'><?= $tot[1]['dias%'] ?></td>
            <td class='derecha'><?= $tot[1]['asist_prev'] ?></td>
            <td class='derecha'><?= $tot[1]['asist_prev%'] ?></td>
            <td class='derecha'><?= $tot[1]['asist'] ?></td>
            <td class='derecha'><?= $tot[1]['asist%'] ?></td>
            <td class='derecha'><?= $tot[1]['in_prev_acu'] ?>
            <td class='derecha'><?= $tot[1]['in_prev_acu%'] ?></td>
            <td class='derecha'><?= $tot[1]['in_acu'] ?></td>
            <td class='derecha'><?= $tot[1]['in_acu%'] ?></td>
            <td class='derecha'><?= $tot[1]['gasto'] ?></td>
            <td class='derecha'><?= $tot[1]['gasto%'] ?></td>
            <td class='derecha'><?= $tot[1]['aportacion'] ?></td>
            <td class='derecha'><?= $tot[1]['superavit'] ?></td>

        </tr>
        <tr>
            <td>dlbf</td>
            <td class='derecha'><?= $tot[2]['dias'] ?></td>
            <td class='derecha'><?= $tot[2]['dias%'] ?></td>
            <td class='derecha'><?= $tot[2]['asist_prev'] ?></td>
            <td class='derecha'><?= $tot[2]['asist_prev%'] ?></td>
            <td class='derecha'><?= $tot[2]['asist'] ?></td>
            <td class='derecha'><?= $tot[2]['asist%'] ?></td>
            <td class='derecha'><?= $tot[2]['in_prev_acu'] ?></td>
            <td class='derecha'><?= $tot[2]['in_prev_acu%'] ?></td>
            <td class='derecha'><?= $tot[2]['in_acu'] ?></td>
            <td class='derecha'><?= $tot[2]['in_acu%'] ?></td>
            <td class='derecha'><?= $tot[2]['gasto'] ?></td>
            <td class='derecha'><?= $tot[2]['gasto%'] ?></td>
            <td class='derecha'><?= $tot[2]['aportacion'] ?></td>
            <td class='derecha'><?= $tot[2]['superavit'] ?></td>

        </tr>
        <tr>
            <td>totales</td>
            <td class='derecha'><?= $tot[1]['dias'] + $tot[2]['dias'] ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= $tot[1]['asist_prev'] + $tot[2]['asist_prev'] ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= $tot[1]['asist'] + $tot[2]['asist'] ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= round(($tot[1]['in_prev_acu'] + $tot[2]['in_prev_acu']), 2) ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= round(($tot[1]['in_acu'] + $tot[2]['in_acu']), 2) ?></td>
            <td class='derecha'></td>
            <td class='derecha'><?= $tot[0]['gasto'] ?></td>
            <td class='derecha'></td>
            <td></td>
            <td class='derecha'><?= round(($tot[1]['superavit'] + $tot[2]['superavit']), 2) ?></td>
    ...
    foreach ($a_resumen as $id_ubi => $row_any) {
        ...
        <table border=1>
            ...
            <tr>
                <td><span id='span_detalles_<?= $id_ubi ?>_<?= $any ?>' class=link
                          onclick=fnjs_detalles(<?= $id_ubi ?>,<?= $any ?>)><p><?= _("mostrar detalles") ?><p><p
                                style="display: none"><?= _("ocultar detalles") ?><p></span></td>
                <td>dlbf</td>
                <td class='derecha'><?= $row[2]['dias'] ?></td>
                <td class='derecha'><?= $row[2]['dias%'] ?></td>
                <td class='derecha'><?= $row[2]['asist_prev'] ?></td>
