...
<table>
   ...
   <td><?= _("tarifa"); ?></td>
	...
	<tr><td><?= _("actual"); ?></td><?= $cantidad_txt ?></tr>
   	<tr><td><?= _("previsión"); ?></td><?= $prevision_txt ?></tr>
   	<tr><td><?= _("incremento"); ?></td><?= $incremento_txt ?></tr>
	<tr><td><input type="button" onclick="fnjs_guardar('frm_tarifas');" value="grabar tarifas"></td></tr>
</table>
</form>
...
<li><span class=contenido><?= $p_tarifa ?> €</span> [p_tarifa] <?= _("tarifa media ponderada: prev.ing.actividades/prev.asistencias: [p_tia]/[p_ta]") ?></li>
</ul>
<table border=1>
<tr>
