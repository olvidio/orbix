...
$a_cabeceras = array(array('name' => _("descripción"), 'formatter' => 'clickFormatter'), _("lugar"), _("descripción lugar"), _("idioma"));
...
//    if ($sf_sv == 2) $a_valores[$i]['clase'] = "tono2";
    ...
    $a_valores[$i][1] = $desc_enc;
//    $a_valores[$i][1] = array('ira' => $pagina, 'valor' => $desc_enc);
    $a_valores[$i][2] = $nombre_ubi;
    $a_valores[$i][3] = $desc_lugar;
    $a_valores[$i][4] = $idioma;
}
