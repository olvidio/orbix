...
class TarifaUbi Extends core\ClasePropiedades {
	...
	public function DBGuardar() {
		...
		if ($bInsert === FALSE) {
			...
			$update="
					cantidad                 = :cantidad,
					observ                   = :observ";
			if (($oDblSt = $oDbl->prepare("UPDATE $nom_tabla SET $update WHERE id_ubi='$this->iid_ubi' AND id_tarifa='$this->iid_tarifa' AND year='$this->iyear' AND id_serie='$this->iid_serie'")) === FALSE) {
			...
			// INSERT
			array_unshift($aDades, $this->iid_ubi, $this->iid_tarifa, $this->iyear, $this->iid_serie);
	...
	public function DBCarregar($que=null) {
		$oDbl = $this->getoDbl();
		$nom_tabla = $this->getNomTabla();
		if (isset($this->iid_ubi) && isset($this->iid_tarifa) && isset($this->iyear) && isset($this->iid_serie)) {
			if (($oDblSt = $oDbl->query("SELECT * FROM $nom_tabla WHERE id_ubi='$this->iid_ubi' AND id_tarifa='$this->iid_tarifa' AND year='$this->iyear' AND id_serie='$this->iid_serie'")) === FALSE) {
	...
	public function DBEliminar() {
		$oDbl = $this->getoDbl();
		$nom_tabla = $this->getNomTabla();
		if (($oDbl->exec("DELETE FROM $nom_tabla WHERE id_ubi='$this->iid_ubi' AND id_tarifa='$this->iid_tarifa' AND year='$this->iyear' AND id_serie='$this->iid_serie'")) === FALSE) {
