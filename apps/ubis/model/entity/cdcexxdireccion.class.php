...
use core;
/**
 * Fitxer amb la Classe que accedeix a la taula u_cross_cdc_ex_dir
 *
 * @package delegación
 * @subpackage model
 ...
 */
/**
 * Classe que implementa l'entitat u_cross_cdc_ex_dir
 *
 * @package delegación
 * @subpackage model
 * @author Daniel Serrabou
 ...
 * @created 11/02/2014
 */
class CdcExxDireccion Extends CdcxDireccion {
	/* ATRIBUTS ----------------------------------------------------------------- */
