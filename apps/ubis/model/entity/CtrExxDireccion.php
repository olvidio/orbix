...
/**
 * Fitxer amb la Classe que accedeix a la taula u_cross_ctr_ex_dir
 *
 * @package delegación
 * @subpackage model
...
/**
 * Clase que implementa la entidad u_cross_ctr_ex_dir
 *
 * @package delegación
 * @subpackage model
 * @author Daniel Serrabou
 ...
 * @created 11/02/2014
 */
class CtrExxDireccion extends CtrxDireccion
{
    /* ATRIBUTOS ----------------------------------------------------------------- */
